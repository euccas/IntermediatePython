...
TESTS = OrderedDict([
    ...
    ('is_word', 'validation_test.IsWordTests'),
    ('get_4_letter_words', 'search_test.Get4LetterWordsTests'),
    ('get_email', 'search_test.GetEmailTests'),
    ...
    ('is_ip_address', 'validation_test.IsIPAddressTests'),
    ('has_word', 'validation_test.HasWordTests'),
    ('is_email', 'validation_test.IsEmailTests'),
    ('is_phone_number', 'validation_test.IsPhoneNumberTests'),
